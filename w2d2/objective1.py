...
# Base Case
# In normal operation, the value of the left variable which starts of as 0 should always be less than the value of the right variable which starts of as the index of the last element in the array.
